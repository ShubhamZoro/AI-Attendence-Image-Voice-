...
def student_dashboard():
    ...
    with c2:
        ...
        if st.button("Logout",icon=':material/logout:',type='primary',width='stretch',key='loginbackbtn',shortcut="control+backspace"):
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name=st.text_input("Enter your name",placeholder="Shubham Shekhar")
            st.subheader("Optional: Voice Enrollment")
            st.info("Enroll your voice to login using voice authentication in the future")
            audio_data=None
            try:
                    ...
                    with st.spinner("Creating profile..."):
                        ...
                        if encodings:
                            ...
                            if response_data:
                             ...
                             st.error("Couldn't capture you facial features for registration")
            else:
